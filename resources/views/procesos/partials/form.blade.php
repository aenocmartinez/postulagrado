...
<div class="mb-4">
    ...
    <select name="nivelEducativo" id="nivelEducativo"
        ...
        >
        <option value=""></option>
        <option value="Pregrado" {{ old('nivelEducativo') == 'Pregrado' ? 'selected' : '' }}>Pregrado</option>
        <option value="Postgrado" {{ old('nivelEducativo') == 'Postgrado' ? 'selected' : '' }}>Postgrado</option>
    </select>
