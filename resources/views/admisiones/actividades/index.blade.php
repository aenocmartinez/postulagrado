...
<div class="bg-white shadow-md rounded-lg p-6 border border-gray-200 max-w-4xl mx-auto">
    ...
    <div class="flex justify-end mt-6">
        <form id="guardar-todas-form" action="{{ route('actividades.store-masivo', ['id' => $proceso->getId()]) }}" method="POST">
            @csrf
...
@php
    ...
    foreach ($proceso->getActividades() as $actividad) {
        $actividadesTemporales[] = [
            ...
            'fecha_inicio' => \Carbon\Carbon::parse($actividad->getFechaInicio())->format('Y-m-d'),
            'fecha_fin' => \Carbon\Carbon::parse($actividad->getFechaFin())->format('Y-m-d'),
        ];
    }
@endphp
