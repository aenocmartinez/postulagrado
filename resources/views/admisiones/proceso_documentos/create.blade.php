...
<div class="bg-white shadow-md rounded-lg p-6 border border-gray-200 max-w-3xl mx-auto">
    ...
    <form action="{{ route('proceso_documentos.store', $proceso->getId()) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="text" name="nombre" id="nombre"
                ...
                placeholder="Ej: Instructivo de Inscripción" required>
        ...
        <div class="mb-6">
            ...
            <input type="file" name="archivo" id="archivo"
                ...
                required accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png">
